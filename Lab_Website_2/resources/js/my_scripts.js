...
function loadStatsPage()
{
	...
	var win = 0
	var lose = 0
	for(var row_check = 2; row_check < table.rows.length; row_check ++)
	{
		if(parseInt(table.rows[row_check].cells[2].innerHTML) > parseInt(table.rows[row_check].cells[3].innerHTML))
		{
			table.rows[row_check].cells[4].innerHTML = "CU Boulder";
			win += 1
		}
		else
		{
			table.rows[row_check].cells[4].innerHTML = table.rows[row_check].cells[1].innerHTML;
			lose += 1
		}
	}
...
function loadPlayersPage()
{
	...
	{
		myInnerHtml += '<a class="dropdown-item" onclick="switchPlayers('+i+')">' + players[i].name + "</a>"
	}
	document.getElementById("player_selector").innerHTML = myInnerHtml;
}
